 ...
 */
JPush.prototype.pushNotification = function (sendno, receiver, msg, options, callback) {
 ...
 * @param {Function} callback function(err, body){}
 */
JPush.prototype.pushAndroidMessage = function (sendno, receiver, msg, options, callback) {
  if ((typeof options === 'function') && !callback) callback = options;
  var postBody = {};
  postBody.sendno = sendno;
  postBody.app_key = this.appkey;
 ...
 * @param {Function} callback function(err, body){}
 */
JPush.prototype.pushSimpleNotification = function (sendno, receiver, msg, options, callback) {
  if ((typeof options === 'function') && !callback) callback = options;
  var postBody = {};
  postBody.sendno = sendno;
  postBody.app_key = this.appkey;
 ...
 * @param {Function} callback function(err, body){}
 */
JPush.prototype.pushAndroidSimpleMessage = function (sendno, receiver, msg, options, callback) {
  if ((typeof options === 'function') && !callback) callback = options;
  var postBody = {};
  postBody.sendno = sendno;
  postBody.app_key = this.appkey;
