...
var JPUSH_API_URL = 'https://api.jpush.cn:443/v2/push',
    JPUSH_API_URL_NOTIFICATION = 'https://api.jpush.cn:443/v2/notification',
    JPUSH_API_URL_CUSTOM_MESSAGE = 'https://api.jpush.cn:443/v2/custom_message';
...
function postJPushApi (apiUrl,postBody ,callback) {
  ...
  //default 1 min timeout
  var timeout = 60000;
  if(postBody.timeout){
      timeout = postBody.timeout;
