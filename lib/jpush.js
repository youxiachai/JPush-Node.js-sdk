 ...
 * @param callback
 */
JPush.prototype.pushNotification = function (sendno, receiver, msg, platform, callback) {
  var postBody = {};
  ...
  postBody.msg_type = 1;
  postBody.msg_content = msg;
  postBody.platform = platform;
 ...
 * @param callback
 */
JPush.prototype.pushAndroidMessage = function (sendno, receiver, msg, platform, callback) {
  var postBody = {};
  postBody.sendno = sendno;
  postBody.app_key = this.appkey;
  postBody.receiver_type = receiver.type;
 ...
 * @param callback
 */
JPush.prototype.pushSimpleNotification = function (sendno, receiver, txt, platform, callback) {
  var postBody = {};
  postBody.sendno = sendno;
  postBody.app_key = this.appkey;
  postBody.receiver_type = receiver.type;
